// src/components/standard/conversation/mobile/MobileConversationView.tsx
...
/**
 * คอมโพเนนต์สำหรับแสดงหน้าแชทบนมือถือ
 * แยกออกมาจาก ConversationPage เพื่อรองรับการแสดงผลที่แตกต่างระหว่าง mobile และ desktop
 */
const MobileConversationView: React.FC<MobileConversationViewProps> = React.memo(({
  // state
  conversations,
  ...
  return (
    <div className="flex h-full overflow-hidden">
      {/* Conversation List View - แสดงเมื่อไม่ได้เลือกการสนทนาหรือกดปุ่มกลับ */}
      {!showMessageView && (
      ...
      {/* Message View - แสดงเมื่อเลือกการสนทนา */}
      {showMessageView && activeChat && (
        <div className="w-full h-full flex flex-col">
          {/* Header with back button */}
          <div className="h-16 bg-card border-b border-border flex items-center px-4">
            <button
              className="w-10 h-10 flex items-center justify-center rounded-full mr-2 hover:bg-accent"
...
MobileConversationView.displayName = 'MobileConversationView';
